...
coevent_real_cc = {COEVENT_REAL_CC}
coevent_real_cxx = {COEVENT_REAL_CXX}
...
def main():
  ...
  if sys.argv[1:] == ["-E", "-xc++", "-", "-v"] and "clang" in compiler:
    os.execv(coevent_real_cxx,
             [coevent_real_cxx, "-E", "-", "-v", "-no-canonical-prefixes"])
